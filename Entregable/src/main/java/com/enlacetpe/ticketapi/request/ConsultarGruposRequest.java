...
public class ConsultarGruposRequest {
	...
	@NotNull
	private String textoConsultaGrupo;
	...
	public String getTextoConsultaGrupo() {
		return textoConsultaGrupo;
	}

	public void setTextoConsultaGrupo(String textoConsultaGrupo) {
		this.textoConsultaGrupo = textoConsultaGrupo;
	}
