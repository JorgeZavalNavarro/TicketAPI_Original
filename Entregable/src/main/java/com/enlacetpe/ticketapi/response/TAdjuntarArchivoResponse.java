...
public class TAdjuntarArchivoResponse {
	...
	public TAdjuntarArchivoResponse() {
		super();
	}

	public TAdjuntarArchivoResponse(boolean respuestaBoolean, String codigoRespuesta, String descripcionRespuesta,
			String mensajeServicio, String fechaSolicitud, String fechaRespuesta, String folioDocumento) {
		super();
