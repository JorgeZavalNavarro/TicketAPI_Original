...
public class CrearTicketSolicitudResponse {
	...
	public CrearTicketSolicitudResponse() {
		super();
	}

	public CrearTicketSolicitudResponse(Boolean respuestaBoolean, String codigoRespuesta, String descripcionRespuesta,
