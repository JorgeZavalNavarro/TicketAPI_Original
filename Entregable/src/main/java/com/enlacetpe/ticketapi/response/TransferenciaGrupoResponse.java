...
public class TransferenciaGrupoResponse {
	...
	public TransferenciaGrupoResponse() {
		super();
	}

	public TransferenciaGrupoResponse(Boolean respuestaBoolean, String codigoRespuesta, String descripcionRespuesta,
