...
public class ActualizarEstatusOperationResponse {
	...
	public ActualizarEstatusOperationResponse() {
		super();
	}

	public ActualizarEstatusOperationResponse(Boolean respuestaBoolean, String codigoRespuesta,
			String descripcionRespuesta, String mensajeServicio, String fechaSolicitud, String fechaRespuesta,
			String ticketSD) {
		super();
	...
	public ActualizarEstatusOperationResponse(Boolean respuestaBoolean, String codigoRespuesta,
			String descripcionRespuesta, String fechaSolicitud, String fechaRespuesta, String ticketSD) {
		super();
		this.respuestaBoolean = respuestaBoolean;
		this.codigoRespuesta = codigoRespuesta;
		this.descripcionRespuesta = descripcionRespuesta;
